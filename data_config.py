...
gex_feature_file = os.path.join(preprocessed_data_folder, 'features/uq2000_gex_feature.csv')
xena_mut_uq_file = os.path.join(preprocessed_data_folder, 'features/xena_uq2000_mut.csv')
ccle_mut_uq_file = os.path.join(preprocessed_data_folder, 'features/ccle_uq2000_mut.csv')
