...
gex_feature_file = os.path.join(preprocessed_data_folder, 'uq500_gex_feature.csv')
xena_mut_uq_file = os.path.join(preprocessed_data_folder, 'xena_uq500_mut.csv')
ccle_mut_uq_file = os.path.join(preprocessed_data_folder, 'ccle_uq500_mut.csv')
